export const de = {
  ...
  // Home page
  homeSubtitle: 'Wähle ein Spiel',
  homeGamesTitle: 'Verfügbare Spiele',
  homeGamesLoading: 'Spieldaten werden geladen...',
  homeGamesLoadError: 'Spieldaten konnten gerade nicht geladen werden.',
  homeStatusOnline: 'Online',
  homeStatusOffline: 'Offline',

  // PWA
  pwaOfflineMessage:
    'Du bist offline. Bereits aufgerufene Inhalte bleiben verfuegbar.',
  pwaUpdateMessage: 'Eine neue Version der App ist verfuegbar.',
  ...
  legalImprintContactValue: 'Telefon: 015679799165\nE-Mail: {email}',
  ...
  legalPrivacyChapter2: '2. Hosting und Content Delivery Networks (CDN)',
  ...
  legalPrivacyChapter3: '3. Allgemeine Hinweise und Pflichtinformationen',
  ...
  legalPrivacyChapter4: '4. Datenerfassung auf dieser Website',
  legalPrivacyWhatsappTitle: 'Kommunikation via WhatsApp',
