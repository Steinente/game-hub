export const en = {
  ...
  // Home page
  homeSubtitle: 'Choose a game',
  homeGamesTitle: 'Available games',
  homeGamesLoading: 'Loading game data...',
  homeGamesLoadError: 'Game data could not be loaded right now.',
  ...
  legalPrivacyChapter2: '2. Hosting and Content Delivery Networks (CDN)',
  legalPrivacyCloudflareTitle: 'Cloudflare',
  legalPrivacyCloudflareBody:
  ...
  legalPrivacyChapter3: '3. General information and mandatory information',
